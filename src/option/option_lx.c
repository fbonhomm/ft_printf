...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/08/03 11:13:26 by fbonhomm          #+#    #+#             */
/*   Updated: 2016/08/16 19:59:57 by fbonhomm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

void				set_info_lx(void)
{
...
int					size_send_to_precision_lx(char *str)
{
...
int					option_lx(void)
{
	...
	tmp = str;
	set_info_lx();
	len = size_send_to_precision_lx(str);
